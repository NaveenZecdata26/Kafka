...
public class KafkaConfig {
    ...
    @KafkaListener(topics = LOCATION_UPDATE_TOPIC, topicPartitions = @TopicPartition(topic = "updated-location",partitions = {"0"}),groupId = GROUP_ID)
    public void updatedLocation(String updatedLocation) {
        System.out.println("partition-0" +updatedLocation);
